...
public class MyTeamMemberActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyTeamMemberAdapter(this);
...
//                startActivity(intent);
    ...
    public void onEventMainThread(MemberEvent event) {
        ...
        if(event.getEventName().equals(MemberEvent.MEMBER_KICK))
        {
            final User user = (User)event.getData();

            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage("确认踢出 "+user.getNickname()+"?");
            builder.setTitle("踢出队伍");

            builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which)
                {

                    StringRequest stringRequest = new StringRequest(Request.Method.GET, HttpUtil.getAbsoluteUrl("teamuser/json/quit?tid=" + team.getId().toString()
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(rs==1)
                                {
                                    Toast.makeText(MyTeamMemberActivity.this, getString(R.string.action_success), Toast.LENGTH_SHORT).show();
                                    refresh();
...
//            });
    ...
    {
        Intent intent = new Intent(MyTeamMemberActivity.this,TeamMemberAddActivity.class);
    ...
    {
        Intent intent = new Intent(MyTeamMemberActivity.this,MyTeamChangeActivity.class);
