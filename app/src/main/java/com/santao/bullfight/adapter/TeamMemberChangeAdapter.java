 ...
 */
public class TeamMemberChangeAdapter extends BaseRecyclerViewAdapter {

    private Context mContext;



    public TeamMemberChangeAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemViewHolder.btn1.setText("设定队长");
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MemberEvent event = new MemberEvent(MemberEvent.MEMBER_CAPTAIN);
