...
public class LeagueFightFragment extends BaseFragment {
    ...
    {
        isLoadingMore = true;
        String url = HttpUtil.getAbsoluteUrl("matchfight/json/matchlist?matchType=3&p=" + page+"&leagueid="+leagueid);
