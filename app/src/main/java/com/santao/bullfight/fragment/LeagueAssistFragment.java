...
import com.santao.bullfight.adapter.LeagueAssistAdapter;
...
public class LeagueAssistFragment extends BaseFragment {
    ...
    private LeagueAssistAdapter adapter;
    ...
    protected void initAllMembersView(Bundle savedInstanceState) {
        ...
        adapter = new LeagueAssistAdapter(getActivity());
...
//                recyclerView.setAdapter(adapter);
    ...
    private void getData()
    {
        ...
        isLoadingMore = true;
        String url = HttpUtil.getAbsoluteUrl("matchdatauser/json/leagueassist?leagueid=" + leagueid + "&p=" + page);
