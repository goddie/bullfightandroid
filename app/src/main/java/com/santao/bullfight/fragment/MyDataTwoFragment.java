 ...
 */
public class MyDataTwoFragment extends BaseFragment {
    ...
    public int getContentViewId() {
        return R.layout.fragment_my_data_two;
    }
...
//                recyclerView.setAdapter(adapter);
    ...
    private void getData()
    {
        ...
        isLoadingMore = true;
        String url = HttpUtil.getAbsoluteUrl("matchdatauser/json/usermatch?uid=" + user.getId() + "&p=" + page);
