...
import com.santao.bullfight.activity.LeagueFightActivity;
...
public class LeagueFragment extends BaseFragment {
    ...
    protected void initAllMembersView(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, Object id) {
                League entity = (League) id;
                Intent intent = new Intent(getActivity(), LeagueFightActivity.class);
                //intent.putExtra("id", entity.getId().toString());

                Bundle bundle = new Bundle();
                bundle.putSerializable("league", entity);
    ...
    private void getData() {
        isLoadingMore = true;
        String url = HttpUtil.getAbsoluteUrl("league/json/list?p=" + page);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        League entity = gson.fromJson(jsonArray.get(i).toString(), League.class);
                        list.add(entity);
                    }
